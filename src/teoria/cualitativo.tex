    ...
    \begin{figure}[ht]
      ...
      \begin{subfigure}{0.33\textwidth}
        ...
        \begin{tikzpicture}
          \draw (-0.5,0) -- (3,0);
          \draw (0,-1) -- (0,2);
          \draw [domain=0:3] plot (\x, {0.7*exp(-\x)+exp(-2*\x)});
        \end{tikzpicture}
      \end{subfigure}%
      \begin{subfigure}{0.33\textwidth}
        \centering
        \begin{tikzpicture}
          \draw (-0.5,0) -- (3,0);
          \draw (0,-1) -- (0,2);
          \draw [domain=0:3] plot (\x, {5*exp(-\x)-4*exp(-2*\x)});
        \end{tikzpicture}
      \end{subfigure}%
      \begin{subfigure}{0.33\textwidth}
        \centering
        \begin{tikzpicture}
          \draw (-0.5,0) -- (3,0);
          \draw (0,-1) -- (0,2);
          \draw [domain=0:3] plot (\x, {-4*exp(-\x)+5*exp(-2*\x)});
        \end{tikzpicture}
      \end{subfigure}%
    \end{figure}
  ...
  \item \(c^2 - 4k < 0\) (caso \emph{subamortiguado}): se tienen dos autovalores
    ...
    \begin{figure}[ht]
      ...
      \begin{tikzpicture}
        \draw[->] (-0.5,0) -- (4,0);
        \draw[->] (0,-1.5) -- (0,1.5);
        \draw [domain = 0:3.5, samples=100] plot (\x, {exp(-\x)*cos((4*\x-1) r)});
        \draw [domain = 0:3.5, dotted] plot (\x, {exp(-\x)});
        \draw [domain = 0:3.5, dotted] plot (\x, {-exp(-\x)});
