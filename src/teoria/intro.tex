...
Comenzamos viendo algunos conceptos fundamentales para el estudio de las
ecuaciones diferenciales ordinarias, estas son ecuaciones diferenciales que 
contienen una o varias funciones en una sola variable, que como
veremos normalmente indicará el tiempo, y será el único tipo de ecuaciones que
abordaremos en este curso.

El término \textquote{ordinaria} se usa en contraposición al de ecuación 
diferencial parcial, una ecuación diferencial en la cual aparecen funciones 
en varias variables.
...
(Ecuación del calor), son ecuaciones diferenciales parciales, veremos también
que muchos fenómenos pueden ser modelados con ecuaciones diferenciales
ordinarias.

Aunque antes de abordar estas cuestiones en detalle necesitamos introducir 
