...
\[\frac{x'(t)}{x(t)} = a(t) \iff \log\abs{x(t)} = \int_{\beta}^t a(s) \dif s + c,
...
\begin{solution}
	...
	\[x(t) = \frac{k}{t} + \frac{t \sin t + \cos t}{t} = \frac{1}{t}(k + t \sin t + \cos t).\]
...
lineal
\begin{align*}
  (1 - n)\frac{x'}{x^n} &= (1-n)a(t)x^{1-n} + (1-n)b(t)\iff \\ y' &= (1 - n)a(t)y + (1 - n)b(t)
\end{align*}
